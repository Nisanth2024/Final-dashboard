        ...
        <Stack spacing={4}>
          ...
          <Flex gap={2}>
            <Button
              ...
              className={`flex-1 ${personType === 'candidate' ? 'bg-white text-black' : ''} hover:bg-emerald-700`}
            >
            ...
            <Button
              ...
              className={`flex-1 ${personType === 'interviewer' ? 'bg-white text-black' : 'text-black'} hover:bg-emerald-700`}
            >
